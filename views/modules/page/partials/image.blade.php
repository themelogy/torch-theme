@php
    ...
    switch ($img->position) {
        case 'top':
            $img->class->push('img-fluid mb-3 shadow');
            break;
        case 'bottom':
            $img->class->push('img-fluid mt-3 shadow');
            break;
        case 'left':
            $img->class->push('float-start me-3 mb-3 shadow');
            break;
        case 'right':
        $img->class->push('float-end ms-3 mb-3 shadow');
        break;
        default:
        $img->class->push('mb-3 shadow');
    }
